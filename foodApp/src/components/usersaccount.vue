<template>
    ...
    <v-container class="mt-3">
         <v-img src="../assets/u.png" class="mx-auto" aspect-ratio="1.2" width="100px"></v-img>
            ...
            <v-card shaped>
             <v-card-title> <h6>#Your history so far</h6></v-card-title>
                 <v-card-text>
                    <v-simple-table  fixed-header height="250px"  width="100px">
            ...
            async fetchHistory(){
                ...
                await Axios.get(urlhist,fomid).then(r =>{
                    ...
                    for (let index = 0; index < total.length; index++) {
                        arrtotal = [...arrtotal,total[index].price * total[index].quantity];
